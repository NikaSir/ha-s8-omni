...
class S8OmniPanel extends HTMLElement {
  ...
  _maintenance() {
    const snap = this._snapshot(); const child = this._state("child_lock"); const childUsable = snap.connected && this._available(child) && this._busyCommands.size === 0;
