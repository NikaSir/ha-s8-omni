  ...
  _styles() {
    return `
      ...
      *{box-sizing:border-box;min-width:0}button,input,select{font:inherit}button{-webkit-tap-highlight-color:transparent}h1,h2,h3,p{margin:0}
      ...
      .resource-chip ha-icon{--mdc-icon-size:27px;color:#19a9e4}.resource-chip.dirty ha-icon{color:#707980}.resource-chip.dustbag ha-icon{color:#6d7479}
      .resource-chip strong,.resource-chip small{display:block;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.resource-chip strong{font-size:13px;line-height:1.08;font-weight:760;letter-spacing:-.015em}.resource-chip small{font-size:11.5px;line-height:1.1;color:var(--secondary-text-color);margin-top:2px}
