...
class S8OmniPanel extends HTMLElement {
  ...
  _resource(key, title, icon, connected) {
    ...
    const minutes = life.minutes === null ? "Нет данных" : `Осталось ${life.minutes} мин`;
