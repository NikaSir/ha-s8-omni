...
Dashboard **v0.7.30** follows **NIKAS Specialized Panel UI Standard v1.8**, **Navigation Contract v1.0** and **NikaS Integration Panel Template v1.8**, with the primary acceptance viewport **iPhone Pro Max portrait**:
