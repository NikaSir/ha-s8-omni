...
> Current development line: **v1.00_b071** (`1.0.0b71`). This is an early test build.
...
Dashboard **v0.7.36** follows **NIKAS Specialized Panel UI Standard v1.9**, **Navigation Contract v1.1** and **NikaS Integration Panel Template v1.9**, with the primary acceptance viewport **iPhone Pro Max portrait**:
