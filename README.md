...
Dashboard **v0.7.30** follows **NIKAS Specialized Panel UI Standard v1.7** and **NikaS Integration Panel Template v1.7**, with the primary acceptance viewport **iPhone Pro Max portrait**:
