const SOURCE = 'custom_components/s8_omni/frontend/s8-omni-panel.js';
...
for (const testedSource of [SOURCE, 'custom_components/s8_omni/frontend/s8-omni-production.js']) {
