...
class PanelCurrentRulesUiV0733Tests(unittest.TestCase):
    ...
    def test_child_modules_are_cache_busted_with_release_version(self) -> None:
        self.assertIn('import "./s8-omni-panel.js?v=1.0.11";', self.bootstrap)
        self.assertIn('import "./s8-omni-cleaning-presets.js?v=1.0.11";', self.bootstrap)
        self.assertIn('import "./s8-omni-service-settings.js?v=1.0.11";', self.bootstrap)
        self.assertIn('import "./s8-omni-preset-live-highlight.js?v=1.0.11";', self.bootstrap)
    ...
    def test_version_metadata_cannot_drift_from_runtime(self) -> None:
        ...
        self.assertIn('const UI_VERSION = "v1.0.11"', self.source)
