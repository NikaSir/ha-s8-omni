...
class StableReleaseMetadataV100Tests(unittest.TestCase):
    ...
    def test_integration_and_ui_release_versions_are_coherent(self) -> None:
        ...
        self.assertIn('const UI_VERSION = "v1.0.0"', source)
        self.assertEqual("v1.0.0", panel["dashboard_version"])
        self.assertEqual(["Пылесос", "UI v1.0.0"], panel["navigation"]["header_center_lines"])
