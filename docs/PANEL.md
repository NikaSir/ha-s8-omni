...
Dashboard `v0.7.44` applies these mobile rules:
...
Each child import is also cache-busted with the integration version (`1.0.0b97`). This prevents a refreshed bootstrap from loading an older child module from browser cache.
